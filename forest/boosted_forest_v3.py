...
params = dict(N=300, max_depth=7, target="CartPole-v2", forest_size=10)
...
F = StochasticArbor()
# weights = np.ones(num_states) / params['N']
...
env.close()
# save F
filename = f'Forest_depth{params["max_depth"]}_samples{params["N"]}_v3_00.pkl'
